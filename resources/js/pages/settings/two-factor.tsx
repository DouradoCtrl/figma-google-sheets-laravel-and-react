                    ...
                    {twoFactorEnabled ? (
                        <div className="flex flex-col items-start justify-start space-y-4">
                            ...
                            <p className="text-muted-foreground">
                                Com a autenticação de dois fatores ativada, você será solicitado a inserir um PIN seguro e aleatório durante o login, que poderá ser obtido no aplicativo compatível com TOTP em seu telefone.
                            </p>
